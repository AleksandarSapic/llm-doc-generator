...
public class PromptTemplates {
    ...
    private static final String FILE_EXPLANATION_TEMPLATE = """
    ...
    private static final String PROJECT_SUMMARY_TEMPLATE = """
    ...
    public String getDefaultFileExplanationTemplate() {
        return FILE_EXPLANATION_TEMPLATE;
    }

    public String getDefaultProjectSummaryTemplate() {
        return PROJECT_SUMMARY_TEMPLATE;
    }

    public String fileExplanationPrompt(String chunkedContent) {
        return FILE_EXPLANATION_TEMPLATE.formatted(chunkedContent);
    }

    public String projectSummaryPrompt(String fileExplanations, String repositoryUrl) {
        return PROJECT_SUMMARY_TEMPLATE.formatted(repositoryUrl, fileExplanations);
    }
}
